				...
				<div class="xs">
					...
					<div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" name="frm" action="upload.php"
								method="post" enctype="multipart/form-data">
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Title</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="title"
											id="title" placeholder="Project Title" required>
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="titlecontent"
											id="titlecontent" placeholder="Title Content" required>
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="services"
											id="services" placeholder="Service Name" required>
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1"
											...
											placeholder="Service Content" required>

									</div>
								</div>

								<div class="form-group">
									<label for="inputPassword" class="col-sm-2 control-label">Select
										Category</label>
									<div class="col-sm-8">
										<select name="table">
								...
								<div class="form-group">
									...
									<div class="col-sm-8 col-sm-offset-">
										...
										<input class="btn-success btn" class="files" name="file[]"
											type="file" multiple="multiple" required><br>

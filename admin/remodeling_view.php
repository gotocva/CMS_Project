...
<?php
        ...
        $sql = mysqli_query($conn,"SELECT * FROM remodeling ORDER BY id ASC");
...
<br>
<center><h3>Display remodeling  </h3></center>
<!-- /.table-responsive -->
   ...
   <tbody>
     ...
     <tr>
       ...
       <td><img height="100" width="100" src="<?php echo $rows['img4']; ?>"</td>
                   ...
                   $eurl1 = $eurl."?id=".$rows['id']."&table=remodeling";
                  ?>

<td><?php echo '<a href="'.$eurl1.'" class="btn btn-sm btn-danger">Edit</a>'; ?></td>
                   <?php  $url = "delete.php";
                               $url1 = $url."?id=".$rows['id']."&table=remodeling";
                              ?>

					...
					<div class="tab-pane active" id="horizontal-form">
						<form class="form-horizontal" name="frm" action="" method="post">
							...
							<div class="form-group">
								<label for="focusedinput" class="col-sm-2 control-label">New
									Password :</label>
								<div class="col-sm-8">
									<input type="text" class="form-control1" name="pwd" id="pwd"
							...
							<div class="form-group">
								<label for="inputPassword" class="col-sm-2 control-label">Confirm
									Password :</label>
								<div class="col-sm-8">
									<input type="text" class="form-control1" name="pwd1" id="pwd1"

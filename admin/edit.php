  	      ...
  	      <center> <h3>Add Testimonial </h3></center>
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" name="frm" action="edit_testimonial.php" method="post">
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Author</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="author" id="author" placeholder="<?php echo $rows['author'];?>">
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="content" id="content" placeholder="<?php echo $rows['content']; ?>">

  	      ...
  	      <center> <h3>Edit Project </h3></center>
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" name="frm" action="" method="post" enctype="multipart/form-data">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="title" id="title" placeholder="<?php echo $rows['title']; ?>" >
									</div>
                ...
                <div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="titlecontent" id="titlecontent" placeholder="<?php echo $rows['titlecontent']; ?>" >
									</div>
                ...
                <div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="services" id="services" placeholder="<?php echo $rows['services']; ?>" >
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="servicescontent" id="servicescontent" placeholder="<?php echo $rows['servicescontent']; ?>" >
                ...
                <span><a href="javascript:void(0);" class="add" >Add More</a></span><br>
                     <input class="btn-success btn" class="files" name="file[]" type="file" multiple="multiple" ><br>

			...
			<div class="col_3">
				<div class="col-md-3 widget widget1">
					<div class="r3_counter_box">
						...
						<div class="stats">
							<a href="testimonial.php"> <strong>Add Testimonial</strong>
							</a>
			...
			<div class="col_3">
				<div class="col-md-3 widget widget1">
					<div class="r3_counter_box">
						<i class="pull-left fa fa-thumbs-up icon-rounded"></i>
						<div class="stats">
							<a href="interior_view.php"> <strong>Interior Projects <?php echo $count; ?></strong>
							</a>
			...
			<div class="col_3">
				<div class="col-md-3 widget widget1">
					<div class="r3_counter_box">
						<i class="pull-left fa fa-thumbs-up icon-rounded"></i>
						<div class="stats">
							<a href="exterior_view.php"> <strong>Exterior Projects <?php echo $count1; ?></strong>
							</a>
			...
			<div class="col_3">
				<div class="col-md-3 widget widget1">
					<div class="r3_counter_box">
						<i class="pull-left fa fa-thumbs-up icon-rounded"></i>
						<div class="stats">
							<a href="remodeling_view.php"> <strong>Remodeling Projects <?php echo $count2; ?></strong>
							</a>
				...
				<div class="col_3">
					<div class="col-md-3 widget widget1">
						<div class="r3_counter_box">
							<i class="pull-left fa fa-thumbs-up icon-rounded"></i>
							<div class="stats">
								<a href="projects.php"> <strong>Add Projects</strong>
								</a>
					...
					<div class="col_3">
						<div class="col-md-3 widget widget1">
							<div class="r3_counter_box">
								<i class="pull-left fa fa-thumbs-up icon-rounded"></i>
								<div class="stats">
									<a href="interior_view.php"> <strong>View Interior Projects</strong>
									</a>
						...
						<div class="col_3">
							<div class="col-md-3 widget widget1">
								<div class="r3_counter_box">
									<i class="pull-left fa fa-thumbs-up icon-rounded"></i>
									<div class="stats">
										<a href="exterior_view.php"> <strong>View Exterior Projects</strong>
										</a>
							...
							<div class="col_3">
								<div class="col-md-3 widget widget1">
									<div class="r3_counter_box">
										<i class="pull-left fa fa-thumbs-up icon-rounded"></i>
										<div class="stats">
											<a href="remodeling_view.php"> <strong>View Remodeling
													Projects</strong>
											</a>
...
var detail = new Rickshaw.Graph.HoverDetail({
	graph: graph
					...
					<script src="includes/js/jquery.vmap.sampledata.js"
						type="text/javascript"></script>
					<script src="includes/js/jquery.vmap.world.js"
						type="text/javascript"></script>
	...
	jQuery(document).ready(function() {
		jQuery('#vmap').vectorMap({
		    ...
		    normalizeFunction: 'polynomial'
				...
				<div class="copy">
					<p>
						Copyright &copy; 2016 SAKTHI BUILDERS. All Rights Reserved |
						Design by <a href="http://pepiras.com/" target="_blank">Pepiras</a>
					</p>
				</div>
			</div>
		</div>
